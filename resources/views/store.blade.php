        ...
        <div class="hero-cover">   
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-md-10">
                        <p class='hero-text'>Our
                        <span class='f-color'>instrumrnt</span>Is our new  <span class='f-color'>gun</span>
                        </p>
        ...
        <div class="row">
         <h4 class='text-center'>Our Store</h4>
          <div class="col-md-4">
            ...
            <img src={{ asset('img/2_1.png') }} alt="">
            <div class="holder">
             <p>oud for begginers</p>
            </div>
            <div class="course-info py-2">
             <p>
              <span class='d-block'>lessons : 12</span>
              <span class='d-block'>instrument : oud</span>
              <span class='d-block'>teacher : tarek</span>
          ...
          <div class="col-md-4">
            ...
            <div class="course-info py-2">
             <p>
              ...
              <span class='d-block'>teacher : tarek</span>
              <button class="login-btn">
               <a href="/single_instrument">See more</a>
              </button>
             </p>
            </div>
           </div>
            ...
            <div class="row">
                    ...
                    <div class="col-md-4 my-5 teacher-card">
                        ...
                        <div class="reviw-image">
                            ...
                            <button class='btn login-btn'><a href="/single_instrument">show more</a></button>
                        </div>
                    </div>
                </div>
            </div>
