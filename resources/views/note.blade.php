...
@section('content')
   <!-- hero start -->
        ...
        <div class="hero-cover">   
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-md-10">
                        <p class='hero-text'>
                        <span class='f-color'>Note Sheets </span>Is Our New  <span class='f-color'>languang</span>
                        </p>
    ...
    <div class="courses py-5">
      <div class="container">
        <div class="row">
         <h4 class='text-center'>Note Sheets </h4>

         <?php
         use App\Http\Controllers\MusicalNoteController;
         $n=new MusicalNoteController();
         $notes=$n->index();
         ...
         ?>
          ...
          <div class="col-md-4">
            ...
            <img src={{ asset('img/5_1.png') }} alt="">
            <div class="holder">
             <p>Alf Lela</p>
            </div>
            <div class="course-info py-2">
             <p>
              <span class='d-block'>singer : um kalthom</span>
              <span class='d-block'>written by : marsel</span>
              <span class='d-block'>makam nahawand</span>
